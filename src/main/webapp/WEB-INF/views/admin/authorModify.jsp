...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/authorModify.css'/>">
...
<div class="admin_content_wrap">
    ...
    <div class="admin_content_main">
        <form id="modifyForm" action="<c:url value='/admin/authorModify'/>" method="post">
...
$("#deleteBtn").on("click", function (e){
    ...
    moveForm.attr("action", "<c:url value='/admin/authorDelete'/>");
