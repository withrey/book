...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/authorDetail.css'/>">
        ...
        <div class="form_section">
            ...
            <div class="form_section_content">
                <select class="input_block" name="nationId">
                    ...
                    <option value="01" disabled="disabled" <c:out value=" ${authorInfo.nationId eq '01' ?'selected':''}"/>>국내
                    </option>
                    <option value="02" disabled="disabled" <c:out value=" ${authorInfo.nationId eq '02' ?'selected':''}"/>>국외
                    </option>
                </select>
            </div>
        </div>
...
$("#cancelBtn").on("click", function (e){
    ...
    moveForm.attr("action", "<c:url value='/admin/authorManage'/>");
    moveForm.submit();
...
$("#modifyBtn").on("click", function (e){
    ...
    moveForm.attr("action", "<c:url value='/admin/authorModify'/>");
    moveForm.submit();
