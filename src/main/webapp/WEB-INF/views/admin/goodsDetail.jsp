...
<head>
  ...
  <link rel="stylesheet" href="<c:url value='/css/admin/goodsDetail.css'/>">
...
<div class="admin_content_wrap">
  ...
  <div class="admin_content_main">
    ...
    <div class="form_section">
      ...
      <div class="form_section_content">
        <input name="bookDate" autocomplete="off" readonly="readonly" value="<c:out value="${goodsInfo.bookDate}"/>" disabled>
      </div>
    </div>
    <div class="form_section">
      <div class="form_section_title">
      ...
      <div class="form_section_content">
        <input name="bookPuble" value="<c:out value="${goodsInfo.bookPuble}"/>" disabled>
      </div>
    </div>
    <div class="form_section">
      <div class="form_section_title">
    ...
    <div class="form_section">
      ...
      <div class="form_section_content bit">
        <textarea name="bookInfo" id="bookInfo_textarea" disabled>${goodsInfo.bookInfo}</textarea>
      </div>
    </div>
  ...
  <form id="moveForm" action="<c:url value='/admin/goodsManage'/>" method="get" >
...
$("#modifyBtn").on("click", function (e){
  ...
  $("#moveForm").attr("action", "<c:url value='/admin/goodsModify'/>");
  $("#moveForm").submit();
});
...
$(document).ready(function (){
 ...
 // 대분류
  ...
  $.getJSON("<c:url value='/getAttachList'/>", {bookId : bookId}, function (arr){

    if(arr.length === 0) {

      let str = "";
      str += "<div id='result_card'>";
      str += "<img src='<c:url value="/img/goodsNoImage.png"/>'>";
      str += "</div>";
