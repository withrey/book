...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/goodsModify.css'/>">
    ...
    <div class="admin_content_main">
        <form action="<c:url value='/admin/goodsModify'/>" method="post" id="modifyForm">
            ...
            <div class="form_section">
                ...
                <div class="form_section_content">
                    <input name="bookDate" autocomplete="off" readonly="readonly"
                           value="<c:out value="${goodsInfo.bookDate}"/>">
            ...
            <div class="form_section">
                ...
                <div class="form_section_content">
                    <input name="bookPuble" value="${goodsInfo.bookPuble}">
            ...
            <div class="form_section">
                ...
                <div class="form_section_content bif">
                    <textarea name="bookInfo" id="bookInfo_textarea">${goodsInfo.bookInfo}</textarea>
...
<script>
    ...
    $("#deleteBtn").on("click", function (e) {
        ...
        moveForm.attr("action", "<c:url value='/admin/goodsDelete'/>");
    ...
    $("#cancelBtn").on("click", function (e) {
        ...
        $("#moveForm").attr("action", "<c:url value='/admin/goodsManage'/>");
        $("#moveForm").submit();
    });
