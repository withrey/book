...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/authorPop.css'/>">
...
<div class="content_wrap">
    ...
    <div class="author_table_wrap">
        ...
        <div class="search_wrap">
            <form id="searchForm" action="<c:url value='/admin/authorPop'/>" method="get">
        ...
        <form id="moveForm" action="<c:url value='/admin/authorPop'/>" method="get">
