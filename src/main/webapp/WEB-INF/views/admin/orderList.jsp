...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/orderList.css'/>">
    <script
...
<div class="admin_content_wrap">
            ...
            <table class="order_table">
                ...
                <c:forEach items="${list}" var="list">
                    <tr>
                        ...
                        <td><c:out value="${list.memId}"></c:out></td>
    ...
    <div class="search_wrap">
        <form id="searchForm" action="<c:url value='/admin/orderList'/>" method="get">
    ...
    <form id="moveForm" action="<c:url value='/admin/orderList'/>" method="get">
        <input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}">
        <input type="hidden" name="amount" value="${pageMaker.cri.amount}">
        <input type="hidden" name="keyword" value="${pageMaker.cri.keyword}">
    </form>

    <form id="deleteForm" action="<c:url value='/admin/orderCancel'/>" method="post">
