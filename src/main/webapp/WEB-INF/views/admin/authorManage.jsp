...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/authorManage.css'/>">
    <script
...
<div class="admin_content_wrap">
    ...
    <div class="search_wrap">
        <form id="searchForm" action="<c:url value='/admin/authorManage'/>" method="get">
    ...
    <form id="moveForm" action="<c:url value='/admin/authorManage'/>" method="get">
...
$(".move").on("click", function(e){
    ...
    moveForm.attr("action", "<c:url value='/admin/authorDetail'/>");
    moveForm.submit();
