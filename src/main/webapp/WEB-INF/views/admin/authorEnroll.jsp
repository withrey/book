...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/authorEnroll.css'/>">
    <script
...
<div class="admin_content_wrap">
    ...
    <div class="admin_content_main">
        <form action="<c:url value='/admin/authorEnroll'/>" method="post" id="enrollForm">
...
<script>
    ...
    $("#cancelBtn").click(function () {
        location.href = "<c:url value='/admin/authorManage'/>"
    });
