...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/admin/goodsManage.css'/>">
    <script
...
<div class="admin_content_wrap">
    ...
    <div class="search_wrap">
        <form id="searchForm" action="<c:url value='/admin/goodsManage'/>" method="get">
...
$(".move").on("click", function (e){
    ...
    moveForm.attr("action", "<c:url value='/admin/goodsDetail'/>");
    moveForm.submit();
