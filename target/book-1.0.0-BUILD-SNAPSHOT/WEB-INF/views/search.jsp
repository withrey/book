        ...
        <div class="content_area">
            ...
            <c:if test="${listcheck != 'empty'}">
                ...
                <div class="search_filter">
                    ...
                    <form id="filter_form" action="<c:url value='/search'/>" method="get">
                            ...
                            <c:forEach items="${list}" var="list">
                                <tr>
                                    ...
                                    <td class="detail">
                                        ...
                                        <div class="title">
                                            <a href="<c:url value='/goodsDetail/${list.bookId}'/>">
                                                ${list.bookName}
                                            </a>
                                        </div>
                                        <div class="author">
                                            <fmt:parseDate var="bookDate" value="${list.bookDate}" pattern="yyyy-MM-dd"/>
                                            ${list.authorName} 지음 | ${list.bookPuble} | <fmt:formatDate value="${bookDate}" pattern="yyyy-MM-dd"/>
                                        </div>
                                    </td>
                                    <td class="info">
                ...
                <form id="moveForm" action="<c:url value='/search'/>" method="get">
